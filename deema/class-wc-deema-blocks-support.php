 ...
 */
final class WC_Deema_Blocks_Support extends AbstractPaymentMethodType {
	/**
	 * Payment method name defined by payment methods extending this class.
	 *
	 * @var string
	 */
	protected $name = 'deema';
	...
	public function initialize() {
		$this->settings = get_option( 'woocommerce_deema_settings', [] );
	}
	...
	public function get_payment_method_script_handles() {
		$dependencies = [];
		wp_register_script( 'woocommerce_wc_payment_method_deema', 
			plugins_url('wc-payment-method-deema.js', __FILE__ ),
			 array_merge([], $dependencies ),
			 '',
			 true
			);
		return ['woocommerce_wc_payment_method_deema'];
	}
